  ...
  return (
    <S.Wrapper>
      ...
      <S.OptionWrapper>
        ...
        <S.RadioLabel htmlFor="youtube">사진 1</S.RadioLabel>
        <S.RadioButton type="radio" name="main" value="picture" id="picture" />
        <S.RadioLabel htmlFor="picture">사진 2</S.RadioLabel>
      </S.OptionWrapper>
      <S.ButtonWrapper>
        <S.SubmitButton
          onClick={props.isEdit ? props.onClickEdit : props.onClickMarketWrite}
